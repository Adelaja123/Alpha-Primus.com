...
const Navbar = () => {
  ...
  return (
    <nav className="w-full py-4 px-8 flex justify-between items-center shadow-md sticky top-0 z-50 bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      <div className="md:hidden">
        ...
        {isOpen && (
          <div className="absolute top-full left-0 w-full bg-white dark:bg-gray-900 flex flex-col items-center shadow-md transition-colors">
            {["About", "Skills", "Projects", "Testimonials", "Contact"].map(
              (link) => (
                <a
                  key={link}
